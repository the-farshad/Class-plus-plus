-- Add 'ordering' to the activities.type CHECK constraint. Same recreate-table
-- dance as 0008 — SQLite can't ALTER a CHECK in place.
...
CREATE TABLE activities_new (
  ...
  type TEXT NOT NULL DEFAULT 'submission'
    CHECK (type IN ('submission','poll','poll_pie','rating','word_cloud','ordering')),
  poll_options TEXT,
